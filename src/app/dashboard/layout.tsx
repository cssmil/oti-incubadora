...
const links = [
  ...
  { name: "Equipos participantesss", href: "equipos-participantes" },
  { name: "Integrantes", href: "integrantes" },
  { name: "Talleres", href: "talleres" },
  { name: "Proyectos de emprendimiento", href: "proyectos-emprendimiento" },
  { name: "Desarrollo empresarial", href: "desarrollo-empresarial" },
  { name: "Talleres", href: "talleres" },
  { name: "Empresas participantes", href: "empresas-participantes" },
  { name: "Asistencias técnicas", href: "asistencias-tecnicas" },
  { name: "Ferias y Eventos", href: "ferias-eventos" },
];
